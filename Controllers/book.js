...
exports.getOneBook = (req, res, next) => {
  ...
  exports.createBook = (req, res, next) => {
    ...
    console.log(bookObject); // Affiche le contenu de bookObject dans la console
    delete bookObject._id;
    delete bookObject._userId;
    
    // Correction : déplacez la définition de 'book' avant son utilisation
    const book = new Book({
      ...bookObject,
    ...
    console.log(book); // Placez-le après la définition de 'book'
